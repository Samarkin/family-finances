...
- [ ] **1.1 Project Scaffolding**: Initialize the project structure and development environment.
    - **Requirements**:
...
- [ ] **1.2 Database Schema & Initialization**: Create SQLite schema and an initialization script.
    ...
    - *Note*: Categories are hardcoded in the application logic, not stored in the DB.
